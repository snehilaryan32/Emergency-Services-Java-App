 ...
 * @author sahilpadyal
 */
public class LegalAdminActivity extends javax.swing.JFrame {

    /**
     * Creates new form PoliceAdminActivity
     */
    public LegalAdminActivity() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Welcome To Investigation Portal");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LegalAdminActivity.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LegalAdminActivity().setVisible(true);
            }
        });
    }
